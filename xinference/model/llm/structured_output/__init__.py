...
from xinference.model.llm.structured_output.backend_xgrammar import XgrammarBackend
    ...
    def grammar_init(self, request: Request) -> None:
        ...
        if self.backend is None:
            ...
            if backend == "xgrammar":
                ...
                from xinference.model.llm.structured_output.backend_outlines import (
                    OutlinesBackend)
                ...
                from backend_lm_format_enforcer import (  # noqa: E501
